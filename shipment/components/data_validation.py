...
class DataValidation:
    ...
    def validate_is_categorical_columns_exists(self) -> Tuple[bool, bool]:
        """
    ...
    def initiate_data_validation(self) -> DataValidationArtifacts:
        ...
        try:
            ...
            schema_train_cat_cols_status, schema_test_cat_cols_status = self.validate_is_categorical_columns_exists()
            logging.info(
            ...
            drift_status = None
            if (
                schema_train_cat_cols_status and schema_test_cat_cols_status
                and schema_train_num_cols_status and schema_test_num_cols_status
                and schema_train_col_status and schema_test_col_status
                and not drift
            ):
